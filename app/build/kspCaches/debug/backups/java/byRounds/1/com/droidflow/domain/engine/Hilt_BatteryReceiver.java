...
public abstract class Hilt_BatteryReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((BatteryReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectBatteryReceiver(UnsafeCasts.<BatteryReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
