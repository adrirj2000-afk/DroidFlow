...
public abstract class Hilt_BluetoothReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((BluetoothReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectBluetoothReceiver(UnsafeCasts.<BluetoothReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
