...
public abstract class Hilt_SystemStateReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((SystemStateReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectSystemStateReceiver(UnsafeCasts.<SystemStateReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
